...
myAnimal = Animal('My Animal', 50)
# myAnimal.fly()   #AttributeError: 'Animal' object has no attribute 'fly'
# myAnimal.pet()   #AttributeError: 'Animal' object has no attribute 'pet'
myAnimal.display_health().walk().walk().walk().run().run().run().display_health()

myDog = Dog('My Dog')
# myDog.fly()   #AttributeError: 'Dog' object has no attribute 'fly'
myDog.display_health().walk().walk().walk().run().run().run().pet().pet().pet().display_health()

myDragon = Dragon('My Dragon')
myDragon.display_health().walk().walk().walk().run().run().run().fly().fly().fly().display_health()
